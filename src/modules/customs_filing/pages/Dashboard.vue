    ...
    <div class="filing_content">
      <div class="card filing-content-wrapper">
        <div class="card-header bg-gradient d-flex justify-content-between align-items-center">
          <h4 class="card-title m-0">ICS2 (HBL ENS)</h4>
            ...
            <div class="table-responsive filing_search_responsive_table_wrapper filing_search_bg_color bg-gradient" >
              <table class="table table-borderless filing_search_table">
                <tr class="filing_search_table_row text-center">
                  ...
                  <th class="" style="width: 100px">Liner</th>
                  <th class="" style="width: 200px">Keyword</th>
                ...
                <tr class="filing_search_table_row">
                  ...
                  <td>
                    <select class="form-select" name="filing_type" id="filing_type" >
                      <option value="EUENS" selected>EU ICS-2/ENS</option>
                      <option value="USAMS">USA AMS</option>
                      <option value="JPAFR">JAPAN AFR</option>
...
.filing-content-wrapper .create_new_btn {
  font-size: 13.5px;
  padding: 3px 9px;
